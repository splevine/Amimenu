...
class PusherInstance {
	...
	private static $app_id  = 'XXXXXXXXXXXXXXXXXXX';
	private static $secret  = 'XXXXXXXXXXXXXXXXXXX';
	private static $api_key = 'XXXXXXXXXXXXXXXXXXX';
...
class Pusher
{
	...
	* @return bool|string
	*/
	public function trigger( $channel, $event, $payload, $socket_id = null, $debug = true, $already_encoded = false )
	{
