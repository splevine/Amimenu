...
;(function ( $, window, document, undefined ) {
  ...
  popup = {
   ...
   //$('#linkshare').modal("show");
  // $("#iframeshare").attr("src","https://www.facebook.com/plugins/like.php?href="+encodeURIComponent((opt.buttons.facebook.url !== '' ? opt.buttons.facebook.url : opt.url))+"&t="+opt.text+"&font=trebuchet ms");

     window.open("http://www.facebook.com/sharer.php?s=100&p[url]="+encodeURIComponent((opt.buttons.facebook.url !== '' ? opt.buttons.facebook.url : opt.url))+"&p[title]=Amimenu, "+$('#detailsname').html()+"&p[summary]="+$('#detailsinfo').html()+"&p[images][0]="+$('#detailsimage').attr('src')+"", "sharer", "toolbar=0, status=0, width=900, height=500");
    },
