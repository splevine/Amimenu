...
//$sql="SELECT * FROM jos_gmapfp WHERE 'activation'='$code'";  
$sql="SELECT * FROM jos_gmapfp WHERE `activation`='$code';";

$db->query("SET NAMES utf8");
$rs = $db->query($sql);
if (!$rs) {
    echo "1 An SQL error occured.\n".$sql;
    exit;
}
 ...
 $realid="".$r['id'];
  ...
  $title = $r['nom'];
   ...
   $lng = htmlspecialchars(trim($r['glng']));
    ...
    $query_activate_account = "UPDATE jos_gmapfp SET `published`=1 WHERE `activation` = '$code';";
    
$db->query("SET NAMES utf8");
$rss = $db->query($query_activate_account);
if (!$rss) {
...
$subject = 'Amimenu activated'; 
//define the message to be sent. Each line should be separated with \n
$message = "Thanks, enjoy Amimenu!"; 
//define the headers we want passed. Note that they are separated with \r\n
$headers = "From: slaptot@gmail.com\r\nReply-To: slaptot@gmail.com";
//send the email
if($published==0){
$activated="Activated!";
